      ...
      <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="space-y-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Connect your accounts to access emails, calendar, and CRM data.</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
              <div class="flex items-center justify-between mb-4">
                ...
                <div class={"w-3 h-3 rounded-full #{if @google_connected, do: "bg-green-400", else: "bg-gray-300"}"}></div>
              </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
              <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                  <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center border border-gray-200">
                    <svg class="w-6 h-6" viewBox="0 0 24 24">
                      <path fill="#FF7A59" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10z"/>
                      <path fill="#FF7A59" d="M12 4c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm0 14c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6z"/>
                      <path fill="#FF7A59" d="M12 8c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z"/>
                    </svg>
                  </div>
                  <div>
                ...
                <div class={"w-3 h-3 rounded-full #{if @hubspot_connected, do: "bg-green-400", else: "bg-gray-300"}"}></div>
              </div>
